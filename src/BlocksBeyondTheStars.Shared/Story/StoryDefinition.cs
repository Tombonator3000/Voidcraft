...
public sealed class StoryFragment
{
    ...
    /// <summary>Pack-defined lore category used by the reader/icon (for example guardian, veyl or network).</summary>
...
{
    /// <summary>Stable pack id (e.g. "voidcraft_awakening"); keys the per-save story state + the selection UI.</summary>
